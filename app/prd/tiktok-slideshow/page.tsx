export default function TikTokSlideshowPRD() {
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-4xl mx-auto px-6 py-12 prose prose-invert prose-pre:bg-gray-900 max-w-none">
        <article className="whitespace-pre-wrap font-mono text-sm leading-relaxed">
